        ...
        <header className="fixed z-20 text-white w-full bg-[#ed002e] after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
            ...
            `}
                    ...
                    <div className="flex gap-3">
                        {
                            user ? <button className="bg-blue-400 rounded-2xl px-5 text-sm font-medium tracking-wide text-white" onClick={logout} >LOGOUT</button> : <button className="bg-blue-400 rounded-2xl px-5 text-sm font-medium tracking-wide text-white" onClick={logout} ><NavLink to='/login'>LOGIN</NavLink></button>
                        }
