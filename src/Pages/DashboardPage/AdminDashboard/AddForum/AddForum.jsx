...
const AddForum = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const forumAdd = await axiosSecure.post('/forum', forumInfo)
            if (forumAdd.data.insertedId) {
                Swal.fire({
                    title: "Success!",
                    text: "Forum add is Successfully Completed",
                    icon: "success",
                    timer: 2000,
                });
                reset();
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="overflow-hidden rounded bg-white text-slate-500 shadow-md shadow-slate-200">
                ...
                <div className="p-6">
                    <header className="mb-4 md:mb-10 text-center">
                        <h3 className=" text-xl font-bold text-slate-700 uppercase">add new Forum</h3>
                        <p className="text text-xs text-purple-300">add a new forum to ensure and update materials</p>
                    </header>
                    <div className="flex flex-col md:space-y-8">
                        <div className="grid md:grid-cols-2 md:gap-4">
                            <div className="relative mb-6">
                                ...
                                {errors.title && <span className="text-red-500 text-xs">Class name is required</span>}
                            </div>
                            <div className="relative mb-6">
                                <input
                                    id="image"
                        ...
                        <div className="relative mb-6">
                            ...
                            {errors.content && <span className="p-2 text-red-500 text-xs">Content is required</span>}
